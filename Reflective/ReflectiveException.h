...
public:
	...
	template<typename Type>
	static ReflectiveException unsupportedData(const std::source_location& a_location)
	{
		return ReflectiveException(a_location, std::format("Unsupported data \'{}\'", type_name<Type>()));
	}
